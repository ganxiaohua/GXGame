...
{
    public partial class InternalHouseModel : IVersions, IDisposable
    {
        ...
        private ECCWorld world;

        public int Versions { get; private set; }


        public async UniTask Initialize(ECCWorld world, ChunkHouseData houseDataId)
        {
        ...
        private void ChangeHouseUnit()
        {
            ...
            {
                int index = t.Index;
                var entity = ConstCreateEntitys.CreateUnitForMapEditor(this.world, t, house.transform, RemoveUnit);
